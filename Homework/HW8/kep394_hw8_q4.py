...
def find_min_abs_difference(bst):
    ...
    for i in bst.inorder():
        inorder_list.append(i.item.key)
    curr_min_difference = inorder_list[1] - inorder_list[0]
    for i in range(2, len(inorder_list)):
        curr_difference = (inorder_list[i]) - (inorder_list[i] - 1)
        if curr_difference < curr_min_difference:
            curr_min_difference = curr_difference
    return curr_min_difference
